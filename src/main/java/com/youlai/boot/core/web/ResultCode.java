...
public enum ResultCode implements IResultCode, Serializable {
    ...
    /** 二级宏观错误码  */
    USER_REGISTRATION_ERROR(400, "用户注册错误"),
    USER_NOT_AGREE_PRIVACY_AGREEMENT(403, "用户未同意隐私协议"),
    REGISTRATION_COUNTRY_OR_REGION_RESTRICTED(403, "注册国家或地区受限"),

    USERNAME_VERIFICATION_FAILED(400, "用户名校验失败"),
    USERNAME_ALREADY_EXISTS(409, "用户名已存在"),
    USERNAME_CONTAINS_SENSITIVE_WORDS(400, "用户名包含敏感词"),
    USERNAME_CONTAINS_SPECIAL_CHARACTERS(400, "用户名包含特殊字符"),

    PASSWORD_VERIFICATION_FAILED(400, "密码校验失败"),
    PASSWORD_LENGTH_NOT_ENOUGH(400, "密码长度不够"),
    PASSWORD_STRENGTH_NOT_ENOUGH(400, "密码强度不够"),

    VERIFICATION_CODE_INPUT_ERROR(400, "校验码输入错误"),
    SMS_VERIFICATION_CODE_INPUT_ERROR(400, "短信校验码输入错误"),
    EMAIL_VERIFICATION_CODE_INPUT_ERROR(400, "邮件校验码输入错误"),
    VOICE_VERIFICATION_CODE_INPUT_ERROR(400, "语音校验码输入错误"),

    USER_CERTIFICATE_EXCEPTION(400, "用户证件异常"),
    USER_CERTIFICATE_TYPE_NOT_SELECTED(400, "用户证件类型未选择"),
    MAINLAND_ID_NUMBER_VERIFICATION_ILLEGAL(400, "大陆身份证编号校验非法"),

    USER_BASIC_INFORMATION_VERIFICATION_FAILED(400, "用户基本信息校验失败"),
    PHONE_FORMAT_VERIFICATION_FAILED(400, "手机格式校验失败"),
    ADDRESS_FORMAT_VERIFICATION_FAILED(400, "地址格式校验失败"),
    EMAIL_FORMAT_VERIFICATION_FAILED(400, "邮箱格式校验失败"),

    /** 二级宏观错误码  */
    USER_LOGIN_EXCEPTION(401, "用户登录异常"),
    USER_ACCOUNT_FROZEN(403, "用户账户被冻结"),
    USER_ACCOUNT_ABOLISHED(403, "用户账户已作废"),

    USER_PASSWORD_ERROR(401, "用户名或密码错误"),
    USER_INPUT_PASSWORD_ERROR_LIMIT_EXCEEDED(429, "用户输入密码错误次数超限"),
    USER_NOT_EXIST(404, "用户不存在"),

    USER_IDENTITY_VERIFICATION_FAILED(401, "用户身份校验失败"),
    USER_FINGERPRINT_RECOGNITION_FAILED(401, "用户指纹识别失败"),
    USER_FACE_RECOGNITION_FAILED(401, "用户面容识别失败"),
    USER_NOT_AUTHORIZED_THIRD_PARTY_LOGIN(401, "用户未获得第三方登录授权"),

    ACCESS_TOKEN_INVALID(401, "访问令牌无效或已过期"),
    REFRESH_TOKEN_INVALID(401, "刷新令牌无效或已过期"),

    USER_VERIFICATION_CODE_ERROR(400, "验证码错误"),
    USER_VERIFICATION_CODE_ATTEMPT_LIMIT_EXCEEDED(429, "用户验证码尝试次数超限"),
    USER_VERIFICATION_CODE_EXPIRED(400, "用户验证码过期"),

    /** 二级宏观错误码  */
    ACCESS_PERMISSION_EXCEPTION(403, "访问权限异常"),
    ACCESS_UNAUTHORIZED(403, "访问未授权"),
    AUTHORIZATION_IN_PROGRESS(202, "正在授权中"),
    USER_AUTHORIZATION_APPLICATION_REJECTED(403, "用户授权申请被拒绝"),

    ACCESS_OBJECT_PRIVACY_SETTINGS_BLOCKED(403, "因访问对象隐私设置被拦截"),
    AUTHORIZATION_EXPIRED(401, "授权已过期"),
    NO_PERMISSION_TO_USE_API(403, "无权限使用 API"),

    USER_ACCESS_BLOCKED(403, "用户访问被拦截"),
    BLACKLISTED_USER(403, "黑名单用户"),
    ACCOUNT_FROZEN(403, "账号被冻结"),
    ILLEGAL_IP_ADDRESS(403, "非法 IP 地址"),
    GATEWAY_ACCESS_RESTRICTED(403, "网关访问受限"),
    REGION_BLACKLIST(403, "地域黑名单"),

    SERVICE_ARREARS(402, "服务已欠费"),

    USER_SIGNATURE_EXCEPTION(401, "用户签名异常"),
    RSA_SIGNATURE_ERROR(401, "RSA 签名错误"),

    /** 二级宏观错误码  */
    USER_REQUEST_PARAMETER_ERROR(400, "用户请求参数错误"),
    CONTAINS_ILLEGAL_MALICIOUS_REDIRECT_LINK(400, "包含非法恶意跳转链接"),
    INVALID_USER_INPUT(400, "无效的用户输入"),

    REQUEST_REQUIRED_PARAMETER_IS_EMPTY(400, "请求必填参数为空"),

    REQUEST_PARAMETER_VALUE_EXCEEDS_ALLOWED_RANGE(400, "请求参数值超出允许的范围"),
    PARAMETER_FORMAT_MISMATCH(400, "参数格式不匹配"),

    USER_INPUT_CONTENT_ILLEGAL(400, "用户输入内容非法"),
    CONTAINS_PROHIBITED_SENSITIVE_WORDS(400, "包含违禁敏感词"),

    USER_OPERATION_EXCEPTION(400, "用户操作异常"),

    /** 二级宏观错误码  */
    USER_REQUEST_SERVICE_EXCEPTION(503, "用户请求服务异常"),
    REQUEST_LIMIT_EXCEEDED(429, "请求次数超出限制"),
    REQUEST_CONCURRENCY_LIMIT_EXCEEDED(429, "请求并发数超出限制"),
    USER_OPERATION_PLEASE_WAIT(429, "用户操作请等待"),
    WEBSOCKET_CONNECTION_EXCEPTION(500, "WebSocket 连接异常"),
    WEBSOCKET_CONNECTION_DISCONNECTED(1000, "WebSocket 连接断开"),
    USER_DUPLICATE_REQUEST(429, "请求过于频繁，请稍后再试。"),

    /** 二级宏观错误码  */
    USER_RESOURCE_EXCEPTION(404, "用户资源异常"),
    ACCOUNT_BALANCE_INSUFFICIENT(402, "账户余额不足"),
    USER_DISK_SPACE_INSUFFICIENT(507, "用户磁盘空间不足"),
    USER_MEMORY_SPACE_INSUFFICIENT(507, "用户内存空间不足"),
    USER_OSS_CAPACITY_INSUFFICIENT(507, "用户 OSS 容量不足"),
    USER_QUOTA_EXHAUSTED(403, "用户配额已用光"),
    USER_RESOURCE_NOT_FOUND(404, "用户资源不存在"),

    /** 二级宏观错误码  */
    UPLOAD_FILE_EXCEPTION(400, "上传文件异常"),
    UPLOAD_FILE_TYPE_MISMATCH(400, "上传文件类型不匹配"),
    UPLOAD_FILE_TOO_LARGE(413, "上传文件太大"),
    UPLOAD_IMAGE_TOO_LARGE(413, "上传图片太大"),
    UPLOAD_VIDEO_TOO_LARGE(413, "上传视频太大"),
    UPLOAD_COMPRESSED_FILE_TOO_LARGE(413, "上传压缩文件太大"),

    DELETE_FILE_EXCEPTION(500, "删除文件异常"),

    /** 二级宏观错误码  */
    USER_CURRENT_VERSION_EXCEPTION(400, "用户当前版本异常"),
    USER_INSTALLED_VERSION_NOT_MATCH_SYSTEM(400, "用户安装版本与系统不匹配"),
    USER_INSTALLED_VERSION_TOO_LOW(400, "用户安装版本过低"),
    USER_INSTALLED_VERSION_TOO_HIGH(400, "用户安装版本过高"),
    USER_INSTALLED_VERSION_EXPIRED(400, "用户安装版本已过期"),
    USER_API_REQUEST_VERSION_NOT_MATCH(400, "用户 API 请求版本不匹配"),
    USER_API_REQUEST_VERSION_TOO_HIGH(400, "用户 API 请求版本过高"),
    USER_API_REQUEST_VERSION_TOO_LOW(400, "用户 API 请求版本过低"),

    /** 二级宏观错误码  */
    USER_PRIVACY_NOT_AUTHORIZED(403, "用户隐私未授权"),
    USER_PRIVACY_NOT_SIGNED(403, "用户隐私未签署"),
    USER_CAMERA_NOT_AUTHORIZED(403, "用户相机未授权"),
    USER_PHOTO_LIBRARY_NOT_AUTHORIZED(403, "用户图片库未授权"),
    USER_FILE_NOT_AUTHORIZED(403, "用户文件未授权"),
    USER_LOCATION_INFORMATION_NOT_AUTHORIZED(403, "用户位置信息未授权"),
    USER_CONTACTS_NOT_AUTHORIZED(403, "用户通讯录未授权"),

    /** 二级宏观错误码  */
    USER_DEVICE_EXCEPTION(500, "用户设备异常"),
    USER_CAMERA_EXCEPTION(500, "用户相机异常"),
    USER_MICROPHONE_EXCEPTION(500, "用户麦克风异常"),
    USER_EARPIECE_EXCEPTION(500, "用户听筒异常"),
    USER_SPEAKER_EXCEPTION(500, "用户扬声器异常"),
    USER_GPS_POSITIONING_EXCEPTION(500, "用户 GPS 定位异常"),
    ...
    /** 二级宏观错误码  */
    SYSTEM_DISASTER_RECOVERY_FUNCTION_TRIGGERED(503, "系统容灾功能被触发"),

    SYSTEM_RATE_LIMITING(429, "系统限流"),

    SYSTEM_FUNCTION_DEGRADATION(503, "系统功能降级"),

    /** 二级宏观错误码  */
    SYSTEM_RESOURCE_EXCEPTION(500, "系统资源异常"),
    SYSTEM_RESOURCE_EXHAUSTED(500, "系统资源耗尽"),
    SYSTEM_DISK_SPACE_EXHAUSTED(507, "系统磁盘空间耗尽"),
    SYSTEM_MEMORY_EXHAUSTED(500, "系统内存耗尽"),
    FILE_HANDLE_EXHAUSTED(500, "文件句柄耗尽"),
    SYSTEM_CONNECTION_POOL_EXHAUSTED(503, "系统连接池耗尽"),
    SYSTEM_THREAD_POOL_EXHAUSTED(503, "系统线程池耗尽"),

    SYSTEM_RESOURCE_ACCESS_EXCEPTION(500, "系统资源访问异常"),
    SYSTEM_READ_DISK_FILE_FAILED(500, "系统读取磁盘文件失败"),


    /** 一级宏观错误码  */
    THIRD_PARTY_SERVICE_ERROR(502, "调用第三方服务出错"),

    /** 二级宏观错误码  */
    MIDDLEWARE_SERVICE_ERROR(500, "中间件服务出错"),

    RPC_SERVICE_ERROR(500, "RPC 服务出错"),
    RPC_SERVICE_NOT_FOUND(404, "RPC 服务未找到"),
    RPC_SERVICE_NOT_REGISTERED(500, "RPC 服务未注册"),
    ...
    MESSAGE_GROUP_NOT_FOUND(404, "消息分组未查到"),

    CACHE_SERVICE_ERROR(500, "缓存服务出错"),
    KEY_LENGTH_EXCEEDS_LIMIT(400, "key 长度超过限制"),
    VALUE_LENGTH_EXCEEDS_LIMIT(400, "value 长度超过限制"),
    STORAGE_CAPACITY_FULL(507, "存储容量已满"),
    UNSUPPORTED_DATA_FORMAT(415, "不支持的数据格式"),

    CONFIGURATION_SERVICE_ERROR(500, "配置服务出错"),

    NETWORK_RESOURCE_SERVICE_ERROR(500, "网络资源服务出错"),
    VPN_SERVICE_ERROR(500, "VPN 服务出错"),
    CDN_SERVICE_ERROR(500, "CDN 服务出错"),
    DOMAIN_NAME_RESOLUTION_SERVICE_ERROR(500, "域名解析服务出错"),
    GATEWAY_SERVICE_ERROR(502, "网关服务出错"),

    /** 二级宏观错误码  */
    THIRD_PARTY_SYSTEM_EXECUTION_TIMEOUT(504, "第三方系统执行超时"),

    RPC_EXECUTION_TIMEOUT(504, "RPC 执行超时"),

    MESSAGE_DELIVERY_TIMEOUT(504, "消息投递超时"),

    CACHE_SERVICE_TIMEOUT(504, "缓存服务超时"),

    CONFIGURATION_SERVICE_TIMEOUT(504, "配置服务超时"),

    DATABASE_SERVICE_TIMEOUT(504, "数据库服务超时"),

    /** 二级宏观错误码  */
    DATABASE_SERVICE_ERROR(500, "数据库服务出错"),

    TABLE_NOT_EXIST(404, "表不存在"),
    COLUMN_NOT_EXIST(404, "列不存在"),
    DATABASE_EXECUTION_SYNTAX_ERROR(400, "数据库执行语法错误"),

    MULTIPLE_SAME_NAME_COLUMNS_IN_MULTI_TABLE_ASSOCIATION(500, "多表关联中存在多个相同名称的列"),

    DATABASE_DEADLOCK(500, "数据库死锁"),

    PRIMARY_KEY_CONFLICT(409, "主键冲突"),
    INTEGRITY_CONSTRAINT_VIOLATION(400, "违反了完整性约束"),

    DATABASE_ACCESS_DENIED(403, "演示环境已禁用数据库写入功能，请本地部署修改数据库链接或开启Mock模式进行体验"),

    /** 二级宏观错误码  */
    THIRD_PARTY_DISASTER_RECOVERY_SYSTEM_TRIGGERED(503, "第三方容灾系统被触发"),
    THIRD_PARTY_SYSTEM_RATE_LIMITING(429, "第三方系统限流"),
    THIRD_PARTY_FUNCTION_DEGRADATION(503, "第三方功能降级"),

    /** 二级宏观错误码  */
    NOTIFICATION_SERVICE_ERROR(500, "通知服务出错"),
    SMS_REMINDER_SERVICE_FAILED(500, "短信提醒服务失败"),
    VOICE_REMINDER_SERVICE_FAILED(500, "语音提醒服务失败"),
    EMAIL_REMINDER_SERVICE_FAILED(500, "邮件提醒服务失败");
