...
CREATE TABLE `fqc_cabinet_detail` (
                                      ...
                                      `h_ncr_Description3` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '高压柜NCR描述3',
                                      `h_ncr_Description4` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '高压柜NCR描述4',
                                      `h_ncr_Description5` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '高压柜NCR描述5',
                                      `sn_l_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '低压柜SN号',
                                      `l_ncr_Description1` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '低压柜NCR描述1',
                                      `l_ncr_Description2` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '低压柜NCR描述2',
                                      `l_ncr_Description3` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '低压柜NCR描述3',
                                      `l_ncr_Description4` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '低压柜NCR描述4',
                                      `l_ncr_Description5` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '低压柜NCR描述5',
